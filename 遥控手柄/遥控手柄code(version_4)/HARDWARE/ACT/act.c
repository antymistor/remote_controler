        ...
        {printf("B4%d%d",(Analogvalue1/100),(Analogvalue2/10));
			...
			{   
	         ...
	         if(key_value)
				 ...
				 if(Analogvalue4/10)
				 {
					if(Analogvalue4/10 >9){printf("C61%d",Analogvalue4/10);}
					else if(Analogvalue4/10>0){printf("C610%d",Analogvalue4/10);}
					//else if(Analogvalue3/10==0){printf("C2000");}
					else if(Analogvalue4/10>-10){printf("C600%d",(u16)(-Analogvalue4/10));}
					else if(Analogvalue4/10>-100){printf("C60%d",(u16)(-Analogvalue4/10));}
					sprintf(tempstr,"%s%d%s","VERMOV",Analogvalue4/10,"%");writelastsent(tempstr);
					mode3_flag2=1;
				 }
				 else if( (Analogvalue4/10)==0&&(mode3_flag2))
				 {
					 mode3_flag2=0;
					 printf("C6201");
					 writelastsent("VER_STOPPED");
					 delay_ms(100);
					 printf("C6201");
					 //writelastsent("STOPPED");
				 }
